...
const DefaultCurrency balance.Currency = "UAH"

// CurrencyValidator is a validator for the "currency" field enum values. It is called by the builders before save.
func CurrencyValidator(c balance.Currency) error {
	switch c {
	case "USD", "EUR", "UAH":
		return nil
	default:
		return fmt.Errorf("entbalance: invalid enum value for currency field: %q", c)
	}
}
