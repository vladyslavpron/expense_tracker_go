...
func (cq *CategoryQuery) QueryTransactions() *TransactionQuery {
...
func (cq *CategoryQuery) WithTransactions(opts ...func(*TransactionQuery)) *CategoryQuery {
	query := (&TransactionClient{config: cq.config}).Query()
...
func (cq *CategoryQuery) loadTransactions(ctx context.Context, query *TransactionQuery, nodes []*Category, init func(*Category), assign func(*Category, *Transaction)) error {
